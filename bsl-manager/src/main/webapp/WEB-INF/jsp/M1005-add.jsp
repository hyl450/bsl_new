...
<div style="padding:10px 10px 10px 10px">
	<form id="qualityAddForm" class="itemForm" method="post">
	   <table>
	       <tr>
	       ...
	       <tr>
	        ...
	        <tr> 
	        	...
	        	<td width="120" align="right">V型冲击力数值1(J):</td>
	            <td width="210" align="right">
	        ...
	        <tr hidden="true">
	            ...
	            <td width="210" align="right">
	            	<input name="inputUser" id="inputUserM5001Add" class="easyui-textbox" type="text" data-options="required:false" style="width:200px;"></input>
	            </td>
	        </tr>	
	    </table>
	</form>
	<div style="margin-top:10px" align="center">
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitM1005Add()">提交</a>
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="resetM1005Add()">重置</a>
	</div>
</div>
<script type="text/javascript">
	
	//提交表单
	function submitM1005Add(){
		//记录复核人员信息
		var checkUser = $("#user_id").html(); 
		$("#inputUserM5001Add").textbox('setValue',checkUser);
		...
		$.post("/quality/add",$("#qualityAddForm").serialize(), function(data){
			if(data.status == 200){
				...
				$.messager.alert('提示','新增成功!炉号为：'+luId,'info',function(){
					...
					$("#qualityAddWindow2").window('close');
					searchM1005Form();
				});
			}else{
